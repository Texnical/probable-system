...
\entry{Programmer/Analyst Intern}{LeTourneau University                 \hfill          May 2017 - Present} {
    \item Design, develop, maintain, and code review web applications used by all of campus in a Scrum environment using various technologies including SQL, PHP, Perl, JavaScript, Docker, Active Directory, and Bash scripting
}
...
\entry{Nimbus}{Senior Game Project} {
    \item Developed and reviewed underlying systems on team of twelve in agile environment using C++ and OGRE3D (\url{https://github.com/dreac0nic/nimbus})
}
...
\entry{GraviPlay}{Ludum Dare Jam 2012} {
    \item Experienced highly rapid development lifecycle and created multimedia for game development competition in a team of four over seventy two hours.
}
