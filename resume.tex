...
\begin{itemize}[leftmargin=3.5em]
    ...
    \item Intermediate with NodeJS, Docker, Perl, C\#, and Active Directory
    \item Basic experience with Python, Ruby, Lua, Active Directory, Microsoft Access, \LaTeX{}, and batch
