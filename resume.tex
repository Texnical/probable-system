...
\entry{H2BaC}{LightSys Technologies Services} {
    \item Developed an ebook-style MVC Android application to deliver content using Cordova platform, JavaScript, and JQuery (\url{https://github.com/Bacon41/How-to-Become-a-Christian}) (\url{https://play.google.com/store/apps/details?id=org.globalchristians.H2BaC})
}
